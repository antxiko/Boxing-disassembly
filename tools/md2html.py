...
# la casa, con el titulo en katakana y el 0x39 del RC-739. Creditos de personas
# no hay ninguno.
PIE = {
    "es": "<em>Konami's Boxing</em> lo publico Konami para MSX en 1985; su numero de catalogo es RC-736 y son 32 KB. Todos los derechos sobre el juego siguen siendo de sus titulares. Este trabajo es de preservacion, estudio y documentacion, y la imagen del cartucho no se distribuye.",
    "en": "<em>Konami's Boxing</em> was published by Konami for the MSX in 1985; its catalogue number is RC-736 and it is 32 KB. All rights in the game remain with their holders. This is preservation, study and documentation work, and the cartridge image is not distributed.",
}
...
REPO = os.environ.get("BOXING_REPO",
                      "https://github.com/antxiko/Boxing-disassembly")
...
def main(docdir, idioma="en"):
    ...
    for fn in sorted(os.listdir(docdir)):
        ...
        titulo = (m.group(1) if m else fn[:-3]) + " — Konami's Boxing (Konami, 1985)"
