...
**The game is not ours.** *Konami's Boxing* was published by **Konami** for the MSX in 1985;
its catalogue number is **RC-736** and it is 32 KB. All rights over the game
...
The file `src/boxing.asm` is the commented disassembly of the cartridge. It is
...
If you worked on *Konami's Boxing* or hold rights over the game, and you would rather this
